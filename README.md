...
- **endOfDay**: Set a Date object to the end of the day (23:59:59.999).
...
- **normalize**: Function to normalize a string by converting it to lowercase, removing diacritics (accents), and trimming whitespace.
- **rangesOverlap**: Function to check if two date ranges overlap.
- **startOfDay**: Set a Date object to the start of the day (00:00:00.000).
- **stringEquals**: Function to check if two strings are equal after normalizing them.
